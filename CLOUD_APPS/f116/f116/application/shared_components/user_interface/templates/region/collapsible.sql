...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(70059040431694392)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(70059355249694392)
,p_plug_template_id=>wwv_flow_api.id(70059040431694392)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(70059638502694392)
,p_plug_template_id=>wwv_flow_api.id(70059040431694392)
,p_name=>'Sub Regions'
