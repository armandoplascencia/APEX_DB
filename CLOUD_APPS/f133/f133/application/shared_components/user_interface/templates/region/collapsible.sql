...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(104781806506699849)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(104782150437699849)
,p_plug_template_id=>wwv_flow_api.id(104781806506699849)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(104782461251699849)
,p_plug_template_id=>wwv_flow_api.id(104781806506699849)
,p_name=>'Sub Regions'
