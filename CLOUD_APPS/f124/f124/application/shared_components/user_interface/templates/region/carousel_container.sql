...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2006225064963932701)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(902713625185785403)
,p_plug_template_id=>wwv_flow_api.id(2006225064963932701)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(902714138008785403)
,p_plug_template_id=>wwv_flow_api.id(2006225064963932701)
,p_name=>'Slides'
