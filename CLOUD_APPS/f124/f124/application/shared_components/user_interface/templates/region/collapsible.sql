...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2006229809342932708)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(902729788702785418)
,p_plug_template_id=>wwv_flow_api.id(2006229809342932708)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(902730302069785418)
,p_plug_template_id=>wwv_flow_api.id(2006229809342932708)
,p_name=>'Sub Regions'
