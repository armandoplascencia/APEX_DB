...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3976655958371047230)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5241554793922291496)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_api.id(3976655958371047230)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5241554990790291497)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5241555193980291497)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(3976656014489047231)
,p_name=>'&APP_NAME.'
,p_template=>wwv_flow_api.id(3702272350470415460)
...
,p_query_row_template=>wwv_flow_api.id(3702288276062415511)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3976656122854047232)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3976656270549047233)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(3976656370419047234)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5241554167633291489)
,p_plug_name=>'Help'
