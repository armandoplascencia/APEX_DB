...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3702272859393415462)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(915886586892815102)
,p_plug_template_id=>wwv_flow_api.id(3702272859393415462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(915887153859815103)
,p_plug_template_id=>wwv_flow_api.id(3702272859393415462)
,p_name=>'Sub Regions'
