...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3702268113510415455)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(915870471621815081)
,p_plug_template_id=>wwv_flow_api.id(3702268113510415455)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(915870884954815082)
,p_plug_template_id=>wwv_flow_api.id(3702268113510415455)
,p_name=>'Slides'
