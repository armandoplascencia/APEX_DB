...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(10146392625636634867)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(756472001344392865)
,p_plugin_id=>wwv_flow_api.id(10146392625636634867)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(756472386277392865)
,p_plugin_id=>wwv_flow_api.id(10146392625636634867)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(756472818236392865)
,p_plugin_id=>wwv_flow_api.id(10146392625636634867)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(756473804249392867)
,p_plugin_id=>wwv_flow_api.id(10146392625636634867)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(756474542411392867)
,p_plugin_id=>wwv_flow_api.id(10146392625636634867)
