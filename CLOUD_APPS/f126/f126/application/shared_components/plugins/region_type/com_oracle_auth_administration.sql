...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1935363955222860445)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2548541041523676611)
,p_plugin_id=>wwv_flow_api.id(1935363955222860445)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2548541492864676611)
,p_plugin_id=>wwv_flow_api.id(1935363955222860445)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2548541910869676611)
,p_plugin_id=>wwv_flow_api.id(1935363955222860445)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2548542270924676612)
,p_plugin_id=>wwv_flow_api.id(1935363955222860445)
,p_attribute_scope=>'COMPONENT'
