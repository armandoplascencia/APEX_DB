...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1797849259226014317)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(900776902785703648)
,p_plug_template_id=>wwv_flow_api.id(1797849259226014317)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(900777439459703648)
,p_plug_template_id=>wwv_flow_api.id(1797849259226014317)
,p_name=>'Sub Regions'
