...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2956289730569893250)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1144552100632607642)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(2956289730569893250)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(1144552489370607642)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1144555294139607645)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(1144552100632607642)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1144552895973607642)
,p_name=>'P41_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2956289730569893250)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1144553239293607643)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(210791822438073258)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(1144552100632607642)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(210791875379073259)
,p_event_id=>wwv_flow_api.id(210791822438073258)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1144554764442607645)
...
,p_process_when_button_id=>wwv_flow_api.id(1144552489370607642)
,p_process_success_message=>'Application appearance settings updated successfully.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1144554422805607644)
