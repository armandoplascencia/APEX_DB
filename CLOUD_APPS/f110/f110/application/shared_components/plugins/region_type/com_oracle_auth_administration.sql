...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14942883140470300586)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(15541381275227756010)
,p_plugin_id=>wwv_flow_api.id(14942883140470300586)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(15541381643414756010)
,p_plugin_id=>wwv_flow_api.id(14942883140470300586)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(15541382029162756010)
,p_plugin_id=>wwv_flow_api.id(14942883140470300586)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(15541382402217756011)
,p_plugin_id=>wwv_flow_api.id(14942883140470300586)
,p_attribute_scope=>'COMPONENT'
