...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14690167327773251146)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(899604745547584738)
,p_plug_template_id=>wwv_flow_api.id(14690167327773251146)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(899605298343584739)
,p_plug_template_id=>wwv_flow_api.id(14690167327773251146)
,p_name=>'Sub Regions'
