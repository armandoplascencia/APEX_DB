...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(89600896945454275)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(89601177663454275)
,p_plug_template_id=>wwv_flow_api.id(89600896945454275)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(89601407751454275)
,p_plug_template_id=>wwv_flow_api.id(89600896945454275)
,p_name=>'Sub Regions'
