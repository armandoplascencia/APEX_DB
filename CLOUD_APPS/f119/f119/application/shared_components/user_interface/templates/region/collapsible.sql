...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(93323021493968986)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(93323361385968986)
,p_plug_template_id=>wwv_flow_api.id(93323021493968986)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(93323664521968986)
,p_plug_template_id=>wwv_flow_api.id(93323021493968986)
,p_name=>'Sub Regions'
