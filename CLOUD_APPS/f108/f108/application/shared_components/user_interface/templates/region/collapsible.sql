...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(51278519746880077)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(51278895532880077)
,p_plug_template_id=>wwv_flow_api.id(51278519746880077)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(51279101015880077)
,p_plug_template_id=>wwv_flow_api.id(51278519746880077)
,p_name=>'Sub Regions'
