...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19613614737781854)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(19613912214781855)
,p_plug_template_id=>wwv_flow_api.id(19613614737781854)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(19614291992781855)
,p_plug_template_id=>wwv_flow_api.id(19613614737781854)
,p_name=>'Sub Regions'
