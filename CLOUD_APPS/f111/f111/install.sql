...
@@application/shared_components/navigation/lists/github.sql
@@application/shared_components/navigation/lists/desktop_navigation_menu_002.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/js_papaparse_min_js.sql
@@application/shared_components/files/js_progressbar_min_js.sql
@@application/shared_components/files/js_progressbar_min_js_map.sql
@@application/shared_components/files/js_xml2json_js.sql
@@application/shared_components/files/js_papaparse_js.sql
@@application/shared_components/files/js_download_js.sql
...
@@application/shared_components/plugins/dynamic_action/com_gm_csv2table.sql
