...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(95051951925962343)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(95052268499962343)
,p_plug_template_id=>wwv_flow_api.id(95051951925962343)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(95052527339962343)
,p_plug_template_id=>wwv_flow_api.id(95051951925962343)
,p_name=>'Sub Regions'
