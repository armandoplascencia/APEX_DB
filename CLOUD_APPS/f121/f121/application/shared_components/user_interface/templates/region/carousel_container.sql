...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(95036986838962334)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(95037235315962334)
,p_plug_template_id=>wwv_flow_api.id(95036986838962334)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(95037515343962335)
,p_plug_template_id=>wwv_flow_api.id(95036986838962334)
,p_name=>'Slides'
