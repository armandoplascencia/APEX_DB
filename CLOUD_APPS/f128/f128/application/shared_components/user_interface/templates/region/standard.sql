...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(113950643151690978)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(113951001835690978)
,p_plug_template_id=>wwv_flow_api.id(113950643151690978)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(113951245724690978)
,p_plug_template_id=>wwv_flow_api.id(113950643151690978)
,p_name=>'Sub Regions'
