...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(113931132533690956)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(113931416241690956)
,p_plug_template_id=>wwv_flow_api.id(113931132533690956)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(113931714659690956)
,p_plug_template_id=>wwv_flow_api.id(113931132533690956)
,p_name=>'Sub Regions'
