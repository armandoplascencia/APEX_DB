...
@@application/shared_components/user_interface/lovs/locations_name.sql
@@application/shared_components/user_interface/lovs/login_remember_username.sql
@@application/shared_components/user_interface/lovs/new_address_idvarchar2128_primary_key.sql
@@application/shared_components/user_interface/lovs/new_brand_idvarchar2128_primary_key.sql
@@application/shared_components/user_interface/lovs/new_images_idvarchar2128_primary_key.sql
@@application/shared_components/user_interface/lovs/new_respondent_type_idvarchar2128_primary_key.sql
@@application/shared_components/user_interface/lovs/new_supplier_idvarchar2128_primary_key.sql
@@application/shared_components/user_interface/lovs/new_user_idvarchar2128_primary_key.sql
@@application/shared_components/user_interface/lovs/new_user_type_idvarchar2128_primary_key.sql
