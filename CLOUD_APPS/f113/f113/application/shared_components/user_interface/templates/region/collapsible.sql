...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(84425890427269602)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(84426119877269602)
,p_plug_template_id=>wwv_flow_api.id(84425890427269602)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(84426415110269602)
,p_plug_template_id=>wwv_flow_api.id(84425890427269602)
,p_name=>'Sub Regions'
