...
@@application/shared_components/remote_servers/sample_application_github_repositories.sql
@@application/shared_components/data_profiles/sample_application_github_repository_commits.sql
@@application/shared_components/data_profiles/github_repositories.sql
@@application/shared_components/data_profiles/github_repository_issues.sql
@@application/shared_components/data_profiles/github_repository_pulls.sql
@@application/shared_components/web_sources/sample_application_github_repository_commits.sql
@@application/shared_components/web_sources/sample_application_github_repositories.sql
@@application/shared_components/web_sources/sample_application_github_repository_issues.sql
@@application/shared_components/web_sources/sample_application_github_repository_pulls.sql
@@application/shared_components/navigation/lists/home_page.sql
@@application/shared_components/navigation/lists/admin_options.sql
@@application/shared_components/navigation/lists/rest_examples.sql
...
@@application/shared_components/security/authorizations/not_all_endpoints_successfully_tested.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_processes/determine_endpoint_url.sql
@@application/shared_components/logic/application_processes/check_rest_service_availibility.sql
...
@@application/shared_components/logic/application_items/sample_endpoint_url.sql
@@application/shared_components/logic/application_items/sample_service_available.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/deptno_lov.sql
@@application/shared_components/user_interface/lovs/job_lov.sql
@@application/shared_components/user_interface/lovs/status_lov.sql
@@application/pages/page_groups.sql
@@application/comments.sql
@@application/shared_components/navigation/breadcrumbs/breadcrumbs.sql
...
@@application/shared_components/security/authentications/collections_built_in_auth.sql
@@application/shared_components/plugins/web_source_type/com_oracle_apex_restsource_fixedpagesize.sql
...
@@application/deployment/install/install_create_package.sql
