...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3776666963756613676)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905909683015814482)
,p_plug_template_id=>wwv_flow_api.id(3776666963756613676)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905910219872814482)
,p_plug_template_id=>wwv_flow_api.id(3776666963756613676)
,p_name=>'Tabs'
