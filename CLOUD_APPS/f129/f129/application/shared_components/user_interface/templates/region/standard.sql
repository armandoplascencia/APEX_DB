...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3692227943213414771)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905890522113814461)
,p_plug_template_id=>wwv_flow_api.id(3692227943213414771)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905891053710814462)
,p_plug_template_id=>wwv_flow_api.id(3692227943213414771)
,p_name=>'Sub Regions'
