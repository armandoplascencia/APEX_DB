...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3692217483788414749)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905814327956814366)
,p_plug_template_id=>wwv_flow_api.id(3692217483788414749)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905814831838814367)
,p_plug_template_id=>wwv_flow_api.id(3692217483788414749)
,p_name=>'Sub Regions'
