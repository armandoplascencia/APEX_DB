...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3692219191199414753)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905821549310814379)
,p_plug_template_id=>wwv_flow_api.id(3692219191199414753)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905821962643814380)
,p_plug_template_id=>wwv_flow_api.id(3692219191199414753)
,p_name=>'Slides'
