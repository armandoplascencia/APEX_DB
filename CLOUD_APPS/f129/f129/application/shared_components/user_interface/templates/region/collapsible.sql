...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(3692223937082414760)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905837664581814400)
,p_plug_template_id=>wwv_flow_api.id(3692223937082414760)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(905838231548814401)
,p_plug_template_id=>wwv_flow_api.id(3692223937082414760)
,p_name=>'Sub Regions'
