...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(48799545361344000)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(48799860305344000)
,p_plug_template_id=>wwv_flow_api.id(48799545361344000)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(48800180958344001)
,p_plug_template_id=>wwv_flow_api.id(48799545361344000)
,p_name=>'Sub Regions'
