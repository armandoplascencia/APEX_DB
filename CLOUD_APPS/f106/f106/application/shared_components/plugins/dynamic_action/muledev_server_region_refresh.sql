...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(5161253474477473351)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5161253648635475373)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5161254154522477148)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5161254660409478778)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5161261572641740800)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5161288373485081967)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(5161289176255082787)
,p_plugin_attribute_id=>wwv_flow_api.id(5161288373485081967)
,p_display_sequence=>10
,p_display_value=>'Replace'
,p_return_value=>'REPLACE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(5161289548335084211)
,p_plugin_attribute_id=>wwv_flow_api.id(5161288373485081967)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(5161289950413084805)
,p_plugin_attribute_id=>wwv_flow_api.id(5161288373485081967)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5161291056085095834)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(91906012739904232)
,p_plugin_id=>wwv_flow_api.id(5161253474477473351)
,p_attribute_scope=>'COMPONENT'
