...
,p_last_upd_yyyymmddhh24miss=>'20220221081052'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(66995473557607103179)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(67088787967426962844)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100026499682866944)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100026887150866944)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100027270835866945)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100027614163866945)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100028065115866945)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100028453922866945)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100028877918866946)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100029248195866946)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(100029610817866947)
,p_query_column_id=>9
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100018417913866937)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(66995473557607103179)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100018899302866937)
...
,p_button_redirect_url=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:14::'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100030049367866948)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_api.id(67088787967426962844)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100019216679866938)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100019672942866938)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100020032028866938)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100020474198866938)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(100034436471866951)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100020899311866938)
,p_name=>'14_P_SCHEDULER_JOB_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100021281914866939)
,p_name=>'14_P_SCHEDULER_JOB_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'Name'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100021680501866939)
,p_name=>'14_P_SCHEDULER_JOB_ACTION'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'Action'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100022093782866939)
,p_name=>'14_P_SCHEDULER_JOB_STATUS'
,p_item_sequence=>35
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100022434645866939)
,p_name=>'14_P_SCHEDULER_JOB_REPEAT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100022833008866940)
,p_name=>'14_P_SCHEDULER_JOB_STARTDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'Start Date'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100023254194866940)
,p_name=>'14_P_SCHEDULER_JOB_ENDDATE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'End Date'
,p_format_mask=>'DD-MON-YYYY HH24:MI'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100023602707866940)
,p_name=>'14_P_SCHEDULER_JOB_REPEAT_FREQ'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'Repeat'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100024052900866940)
,p_name=>'14_P_SCHEDULER_JOB_REPEAT_DAYS'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100024486161866941)
,p_name=>'14_P_SCHEDULER_JOB_REPEAT_INTV'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_item_default=>'1'
,p_prompt=>'Repeat Interval'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100025332314866943)
,p_name=>'14_P_SCHEDULER_JOB_COMMENTS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'Comments'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100025797081866943)
,p_name=>'14_P_SCHEDULER_JOB_START_BY_HOUR'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(66995473557607103179)
,p_prompt=>'By Hour'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(100033440461866950)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(100033983968866951)
,p_event_id=>wwv_flow_api.id(100033440461866950)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100031838625866949)
...
,p_process_when_button_id=>wwv_flow_api.id(100019216679866938)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100032665604866950)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100032265938866950)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(100019672942866938)
,p_process_when=>'P_SCHEDULER_JOB_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_process_success_message=>'Program removed'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100031061921866949)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100033071434866950)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(100018417913866937)
,p_process_success_message=>'Update successful'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(100031426711866949)
,p_process_sequence=>40
