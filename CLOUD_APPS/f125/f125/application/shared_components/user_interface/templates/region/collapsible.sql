...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(98899900920118597)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(98900246669118598)
,p_plug_template_id=>wwv_flow_api.id(98899900920118597)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(98900509486118598)
,p_plug_template_id=>wwv_flow_api.id(98899900920118597)
,p_name=>'Sub Regions'
