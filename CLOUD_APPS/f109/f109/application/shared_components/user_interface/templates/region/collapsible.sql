...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(64712527246113889)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(64712853357113889)
,p_plug_template_id=>wwv_flow_api.id(64712527246113889)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(64713143505113889)
,p_plug_template_id=>wwv_flow_api.id(64712527246113889)
,p_name=>'Sub Regions'
