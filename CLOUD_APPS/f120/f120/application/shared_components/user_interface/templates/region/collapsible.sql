...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(94623703111367366)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(94624017800367366)
,p_plug_template_id=>wwv_flow_api.id(94623703111367366)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(94624380681367367)
,p_plug_template_id=>wwv_flow_api.id(94623703111367366)
,p_name=>'Sub Regions'
