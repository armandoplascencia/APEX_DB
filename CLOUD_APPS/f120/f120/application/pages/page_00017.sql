...
,p_alias=>'CHOOSE-TABLES'
,p_page_mode=>'MODAL'
,p_step_title=>'Choose Tables'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'MISO'
,p_last_upd_yyyymmddhh24miss=>'20220203000324'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(219599127172305253)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(95871696581140106)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(219599127172305253)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(95872090618140110)
,p_name=>'P17_CHOOSE_TABLES'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(219599127172305253)
...
,p_cHeight=>15
,p_field_template=>wwv_flow_api.id(94706729157367415)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'ALL'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(95872438721140114)
...
'',
'BEGIN',
'   p_tables := APEX_UTIL.string_to_table(:P17_CHOOSE_TABLES);',
'',
