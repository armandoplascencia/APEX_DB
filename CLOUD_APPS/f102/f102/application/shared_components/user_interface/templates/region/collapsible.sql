...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(47240695057673971)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(47240914491673972)
,p_plug_template_id=>wwv_flow_api.id(47240695057673971)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(47241296828673972)
,p_plug_template_id=>wwv_flow_api.id(47240695057673971)
,p_name=>'Sub Regions'
