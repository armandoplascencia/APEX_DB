prompt --application/deployment/install/install_eba_proj_flex_fw_package_spec
begin
--   Manifest
--     INSTALL: INSTALL-eba_proj_flex_fw package spec
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(6243873683853727030)
