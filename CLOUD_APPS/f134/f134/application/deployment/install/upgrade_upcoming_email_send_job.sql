prompt --application/deployment/install/upgrade_upcoming_email_send_job
begin
--   Manifest
--     INSTALL: UPGRADE-Upcoming Email Send Job
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(16977226577607458120)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'Upcoming Email Send Job'
,p_sequence=>450
,p_script_type=>'UPGRADE'
,p_condition_type=>'NOT_EXISTS'
,p_condition=>'select null from user_scheduler_jobs where job_name = ''EBA_PROJ_EMAIL_UPCOMING_JOB'';'
