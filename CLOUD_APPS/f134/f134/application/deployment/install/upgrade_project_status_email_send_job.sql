prompt --application/deployment/install/upgrade_project_status_email_send_job
begin
--   Manifest
--     INSTALL: UPGRADE-Project Status Email Send Job
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(18589634203932720072)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'Project Status Email Send Job'
,p_sequence=>1150
,p_script_type=>'UPGRADE'
,p_condition_type=>'NOT_EXISTS'
,p_condition=>'select null from user_scheduler_jobs where job_name = ''EBA_PROJ_EMAIL_STATUS_JOB'';'
