prompt --application/deployment/install/upgrade_eba_proj_user_preferences
begin
--   Manifest
--     INSTALL: UPGRADE-eba_proj_user_preferences
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(5413076463428881963)
...
'select null',
'from user_tables',
'where table_name = ''EBA_PROJ_USER_PREFERENCES'''))
