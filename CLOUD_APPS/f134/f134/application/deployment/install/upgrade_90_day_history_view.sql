prompt --application/deployment/install/upgrade_90_day_history_view
begin
--   Manifest
--     INSTALL: UPGRADE-90 Day History View
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(18353454896791186829)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'90 Day History View'
,p_sequence=>1110
,p_script_type=>'UPGRADE'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'create or replace view eba_proj_history_90day_v as',
...
'     where f.created >= (trunc(sysdate) - 90)',
'union all',
...
'        and f.deleted_on >= (trunc(sysdate) - 90)',
'union all',
...
'       and f.created >= (trunc(sysdate) - 90)',
'union all',
...
'     where rf.created >= (trunc(sysdate) - 90)',
...
'       and f.change_date >= (trunc(sysdate) - 90)',
'union all',
...
'       and h.change_date >= (trunc(sysdate) - 90)',
'       and exists (select null',
'            from build_options',
'            where build_option_name = ''Project Issues''',
'    );'))
