prompt --application/deployment/install/upgrade_project_details_email_send_job
begin
--   Manifest
--     INSTALL: UPGRADE-Project Details Email Send Job
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(16977220939680415808)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'Project Details Email Send Job'
,p_sequence=>920
,p_script_type=>'UPGRADE'
,p_condition_type=>'NOT_EXISTS'
,p_condition=>'select null from user_scheduler_jobs where job_name = ''EBA_PROJ_EMAIL_SUMMARY_JOB'';'
