prompt --application/deployment/install/upgrade_eba_proj_status_show_detail_procedure
begin
--   Manifest
--     INSTALL: UPGRADE-eba_proj_status_show_detail procedure
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(12051114904832291219)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'eba_proj_status_show_detail procedure'
,p_sequence=>970
