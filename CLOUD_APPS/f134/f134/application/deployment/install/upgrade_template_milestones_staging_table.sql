prompt --application/deployment/install/upgrade_template_milestones_staging_table
begin
--   Manifest
--     INSTALL: UPGRADE-Template Milestones Staging Table
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(20158144020588316771)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'Template Milestones Staging Table'
,p_sequence=>1170
...
'select table_name',
'from user_tables',
'where table_name = ''EBA_PROJ_STG_TMP_MS'''))
