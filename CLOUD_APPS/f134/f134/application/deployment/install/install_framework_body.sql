...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(7949482083753025999)
...
'    end conv_urls_links;',
'',
'    function format_status_update_c',
'    (',
'        p_string      in clob,',
...
wwv_flow_api.create_install_object(
 p_id=>wwv_flow_api.id(6964824050647123874)
,p_script_id=>wwv_flow_api.id(7949482083753025999)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE BODY'
,p_object_name=>'EBA_PROJ_FW'
