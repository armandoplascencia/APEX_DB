prompt --application/deployment/install/upgrade_eba_proj_flex_fw_package_body
begin
--   Manifest
--     INSTALL: UPGRADE-eba_proj_flex_fw package body
--   Manifest End
...
wwv_flow_api.create_install_script(
 p_id=>wwv_flow_api.id(6243875309048760880)
,p_install_id=>wwv_flow_api.id(9012014618759672631)
,p_name=>'eba_proj_flex_fw package body'
,p_sequence=>980
...
'                    open l_refcsr for l_sql using c1.lov_display_col, c1.lov_sql_query, c1.lov_return_col, p_input;',
