prompt --application/shared_components/navigation/lists/data_load_process_train_template_milestones_002
begin
--   Manifest
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(20152600504706729528)
,p_name=>'Data Load Process Train - Template Milestones'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(20152600852248729531)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(20152601259164729533)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(20152601669648729533)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(20152602107280729533)
