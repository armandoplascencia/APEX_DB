...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(6097585308950874457)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7592482490945096519)
,p_plugin_id=>wwv_flow_api.id(6097585308950874457)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7592482916239096520)
,p_plugin_id=>wwv_flow_api.id(6097585308950874457)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1228479047774503541)
,p_plugin_id=>wwv_flow_api.id(6097585308950874457)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7592485721109096523)
,p_plugin_id=>wwv_flow_api.id(6097585308950874457)
