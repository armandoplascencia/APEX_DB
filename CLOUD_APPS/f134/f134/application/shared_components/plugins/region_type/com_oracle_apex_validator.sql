...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(6173539392734245421)
...
'        ||''onclick="''||c_region_link||''" type="button">Validate</button>'');',
...
'        ||''onclick="''||c_region_link||''" type="button">''',
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7576886617609965777)
,p_plugin_id=>wwv_flow_api.id(6173539392734245421)
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1228479275713503552)
,p_plugin_id=>wwv_flow_api.id(6173539392734245421)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(7576887641048965778)
,p_plugin_id=>wwv_flow_api.id(6173539392734245421)
