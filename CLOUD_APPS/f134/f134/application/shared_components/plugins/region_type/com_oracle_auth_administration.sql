...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(6782022911077067176)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7749357168101196217)
,p_plugin_id=>wwv_flow_api.id(6782022911077067176)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7749357545835196218)
,p_plugin_id=>wwv_flow_api.id(6782022911077067176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7749357936954196219)
,p_plugin_id=>wwv_flow_api.id(6782022911077067176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(7749358376177196219)
,p_plugin_id=>wwv_flow_api.id(6782022911077067176)
,p_attribute_scope=>'COMPONENT'
