...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(31901449375877024153)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(808631540248391174)
,p_plugin_id=>wwv_flow_api.id(31901449375877024153)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(808631958181391178)
,p_plugin_id=>wwv_flow_api.id(31901449375877024153)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(808632374571391178)
,p_plugin_id=>wwv_flow_api.id(31901449375877024153)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(808633602143391189)
,p_plugin_id=>wwv_flow_api.id(31901449375877024153)
