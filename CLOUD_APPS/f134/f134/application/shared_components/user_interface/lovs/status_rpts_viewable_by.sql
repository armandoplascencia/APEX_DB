...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(6170164080174692565)
,p_lov_name=>'STATUS RPTS VIEWABLE BY'
,p_lov_query=>'.'||wwv_flow_api.id(6170164080174692565)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6170164385297692572)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Submitter'
,p_lov_return_value=>'Submitter'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6170164704729692577)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Submitter and Project Members'
,p_lov_return_value=>'Submitter and Project Members'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(6170164989645692578)
