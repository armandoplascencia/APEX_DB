prompt --application/shared_components/user_interface/lovs/users_with_upcoming_deliverables
begin
--   Manifest
--     USERS WITH UPCOMING DELIVERABLES
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(11996217752120980219)
,p_lov_name=>'USERS WITH UPCOMING DELIVERABLES'
...
'                        and rf.user_id = u.id',
'    )',
'    and nvl(u.upcoming_reminders_freq, ''NEVER'') != ''NEVER''',
') x',
