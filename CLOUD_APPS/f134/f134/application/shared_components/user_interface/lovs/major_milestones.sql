...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(8139011421273890714)
,p_lov_name=>'MAJOR MILESTONES'
,p_lov_query=>'.'||wwv_flow_api.id(8139011421273890714)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(8139011643956890718)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Major Only'
,p_lov_return_value=>'MAJOR'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(8139011844967890721)
