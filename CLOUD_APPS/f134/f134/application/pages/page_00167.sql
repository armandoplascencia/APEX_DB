...
,p_last_upd_yyyymmddhh24miss=>'20190905172316'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(12093213992476374075)
,p_name=>'Email Upcoming Deliverables Send Job'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12093499422330450944)
,p_query_column_id=>1
,p_column_alias=>'JOB'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12093499592830450945)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(12093499689177450946)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151112424306761335)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151112580990761336)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151112660693761337)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15203461213218552369)
,p_query_column_id=>7
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(12093215634026374087)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(14151719052108943481)
,p_name=>'Job History'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151719329736943484)
,p_query_column_id=>1
,p_column_alias=>'STATUS'
,p_column_display_sequence=>1
,p_column_heading=>'Status'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151719745567943486)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151720134398943486)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(14151720597686943487)
,p_query_column_id=>4
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(525986280147977567)
,p_name=>'Refresh on Edit'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(12093213992476374075)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(525986313318977568)
,p_event_id=>wwv_flow_api.id(525986280147977567)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(12093213992476374075)
);
