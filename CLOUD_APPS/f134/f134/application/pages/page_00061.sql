...
,p_last_upd_yyyymmddhh24miss=>'20190905100523'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1519086307851431580)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1519086456916431581)
,p_region_id=>wwv_flow_api.id(1519086307851431580)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1519086558839431582)
,p_chart_id=>wwv_flow_api.id(1519086456916431581)
,p_seq=>10
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1519086696075431583)
,p_chart_id=>wwv_flow_api.id(1519086456916431581)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1519086734289431584)
,p_chart_id=>wwv_flow_api.id(1519086456916431581)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6823794492602558788)
,p_plug_name=>'Filters'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(9068155214142076216)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(6806623725818987273)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(6823794350796555850)
,p_name=>'P61_STATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(6823794492602558788)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(9068155736483076224)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6825030220821327177)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6825030454834327179)
,p_event_id=>wwv_flow_api.id(6825030220821327177)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1519086864101431585)
,p_event_id=>wwv_flow_api.id(6825030220821327177)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_api.id(1519086307851431580)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(9068155936406076228)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'clear cache for this page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_api.id(6806623725818987273)
);
