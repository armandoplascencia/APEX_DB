...
,p_last_upd_yyyymmddhh24miss=>'20190905150634'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(525985473661977559)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18631899504182336508)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18631899892293336509)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18631901450812336532)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(525985473661977559)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18631901830263336534)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18631905915587336547)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18631900293888336509)
,p_name=>'P131_STATUS_TARGET_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18631899892293336509)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18631900776262336514)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(18631902412343336537)
...
,p_when_button_pressed=>wwv_flow_api.id(18631901830263336534)
,p_associated_item=>wwv_flow_api.id(18631900776262336514)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18631903413079336541)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18631904012015336543)
,p_event_id=>wwv_flow_api.id(18631903413079336541)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18631905414187336545)
,p_event_id=>wwv_flow_api.id(18631903413079336541)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18631904499178336544)
,p_event_id=>wwv_flow_api.id(18631903413079336541)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18631905004221336544)
,p_event_id=>wwv_flow_api.id(18631903413079336541)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(525985599878977560)
,p_name=>'CNX'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18631901450812336532)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(525985617227977561)
,p_event_id=>wwv_flow_api.id(525985599878977560)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18631902643617336539)
...
,p_process_when_button_id=>wwv_flow_api.id(18631901830263336534)
,p_process_success_message=>'Emails sent successfully.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18631903109758336540)
