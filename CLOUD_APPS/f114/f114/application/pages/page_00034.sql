...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(87082667297592919)
...
,p_query_type=>'TABLE'
,p_query_table=>'ND2_MANAGEMENT_SKILLS'
,p_include_rowid_column=>false
,p_plug_source_type=>'NATIVE_IR'
,p_prn_page_header=>'Management Skills'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(87082776082592919)
,p_name=>'Management Skills'
...
,p_owner=>'MISO'
,p_internal_uid=>87082776082592919
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(87083170642592919)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(87083568873592920)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(87083965566592920)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(87372550541595878)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'873726'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(87085403426592921)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(87084661609592920)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(87082667297592919)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(87087283035592922)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(87086324090592922)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(87082667297592919)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(87086814948592922)
,p_event_id=>wwv_flow_api.id(87086324090592922)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(87082667297592919)
);
