...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(86717721494588039)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(86718062477588039)
,p_plug_template_id=>wwv_flow_api.id(86717721494588039)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(86718378160588039)
,p_plug_template_id=>wwv_flow_api.id(86717721494588039)
,p_name=>'Sub Regions'
