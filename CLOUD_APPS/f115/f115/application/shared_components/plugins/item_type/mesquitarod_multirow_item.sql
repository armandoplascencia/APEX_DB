...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(178084057603347508)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(178082657297323859)
,p_plugin_id=>wwv_flow_api.id(178084057603347508)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(178082435196314324)
,p_plugin_id=>wwv_flow_api.id(178084057603347508)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(178082097281309191)
,p_plugin_id=>wwv_flow_api.id(178084057603347508)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(178081766064303673)
,p_plugin_id=>wwv_flow_api.id(178084057603347508)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(178071114629748155)
,p_plugin_id=>wwv_flow_api.id(178084057603347508)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(178083043832335048)
,p_plugin_id=>wwv_flow_api.id(178084057603347508)
