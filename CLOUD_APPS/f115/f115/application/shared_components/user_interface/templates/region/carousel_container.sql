...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(188119653087147834)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107615100561441363)
,p_plug_template_id=>wwv_flow_api.id(188119653087147834)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107615666760441363)
,p_plug_template_id=>wwv_flow_api.id(188119653087147834)
,p_name=>'Slides'
