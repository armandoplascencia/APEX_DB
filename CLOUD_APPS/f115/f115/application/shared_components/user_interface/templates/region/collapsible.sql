...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(188126853010147839)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107631298002441387)
,p_plug_template_id=>wwv_flow_api.id(188126853010147839)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107631828380441387)
,p_plug_template_id=>wwv_flow_api.id(188126853010147839)
,p_name=>'Sub Regions'
