...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(188143897385147850)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107685516824441458)
,p_plug_template_id=>wwv_flow_api.id(188143897385147850)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(107686002588441458)
,p_plug_template_id=>wwv_flow_api.id(188143897385147850)
,p_name=>'Sub Regions'
