...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14959350648552679140)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(901304145697676951)
,p_plug_template_id=>wwv_flow_api.id(14959350648552679140)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(901304668991676951)
,p_plug_template_id=>wwv_flow_api.id(14959350648552679140)
,p_name=>'Sub Regions'
