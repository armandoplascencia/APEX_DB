...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14962327501292511585)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(152321111915515367)
,p_plugin_id=>wwv_flow_api.id(14962327501292511585)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(152321515209515367)
,p_plugin_id=>wwv_flow_api.id(14962327501292511585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(152321878117515367)
,p_plugin_id=>wwv_flow_api.id(14962327501292511585)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(152322288607515367)
,p_plugin_id=>wwv_flow_api.id(14962327501292511585)
,p_attribute_scope=>'COMPONENT'
