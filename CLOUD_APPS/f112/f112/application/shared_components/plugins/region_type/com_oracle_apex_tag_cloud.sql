...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(18813701047671659081)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(756454441963363467)
,p_plugin_id=>wwv_flow_api.id(18813701047671659081)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(756454862850363467)
,p_plugin_id=>wwv_flow_api.id(18813701047671659081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(756455249945363467)
,p_plugin_id=>wwv_flow_api.id(18813701047671659081)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(756457470322363470)
,p_plugin_id=>wwv_flow_api.id(18813701047671659081)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(756458124043363471)
,p_plugin_id=>wwv_flow_api.id(18813701047671659081)
