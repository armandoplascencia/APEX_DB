...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(15721683147852774642)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259729690762166404)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259730089303166405)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259730563004166406)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1259738107647166412)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259730941620166407)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259731359450166407)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259732252710166408)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259732722702166408)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259733280034166409)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259733697889166409)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259734189577166409)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259734705014166409)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259731757454166407)
,p_plugin_attribute_id=>wwv_flow_api.id(1259731359450166407)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259735195611166410)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259735660661166410)
,p_plugin_attribute_id=>wwv_flow_api.id(1259735195611166410)
,p_display_sequence=>0
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259736095876166410)
,p_plugin_attribute_id=>wwv_flow_api.id(1259735195611166410)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259736648573166411)
,p_plugin_attribute_id=>wwv_flow_api.id(1259735195611166410)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259737130583166411)
,p_plugin_attribute_id=>wwv_flow_api.id(1259735195611166410)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259737650116166411)
,p_plugin_attribute_id=>wwv_flow_api.id(1259735195611166410)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259738107647166412)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259738507878166412)
,p_plugin_attribute_id=>wwv_flow_api.id(1259738107647166412)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'BOX'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259739515403166412)
,p_plugin_attribute_id=>wwv_flow_api.id(1259738107647166412)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259739077890166412)
,p_plugin_attribute_id=>wwv_flow_api.id(1259738107647166412)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259740009399166413)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259740408110166413)
,p_plugin_attribute_id=>wwv_flow_api.id(1259740009399166413)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1259740949576166413)
,p_plugin_attribute_id=>wwv_flow_api.id(1259740009399166413)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'N'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1259741444530166414)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1259744579730166425)
,p_plugin_id=>wwv_flow_api.id(15721683147852774642)
,p_name=>'SOURCE_SQL'
