...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(15034073900855639999)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(15797828858697561117)
,p_plugin_id=>wwv_flow_api.id(15034073900855639999)
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1157155598118386346)
,p_plugin_id=>wwv_flow_api.id(15034073900855639999)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(15797829938547561118)
,p_plugin_id=>wwv_flow_api.id(15034073900855639999)
