...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14974865226169173590)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(264247055546786778)
,p_plugin_id=>wwv_flow_api.id(14974865226169173590)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(264247428710786786)
,p_plugin_id=>wwv_flow_api.id(14974865226169173590)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(264248668173786820)
,p_plugin_id=>wwv_flow_api.id(14974865226169173590)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(264249346520786826)
,p_plugin_id=>wwv_flow_api.id(14974865226169173590)
