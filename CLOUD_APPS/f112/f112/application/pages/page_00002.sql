...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14377966315846578813)
,p_plug_name=>'Logo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15944413718999282909)
,p_plug_name=>'RDS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17813728278233726439)
,p_plug_name=>'Project'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(14959353760448679146)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17893933129358456296)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17900413693548127528)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17900418872159127603)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17900413778361127529)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(17900418872159127603)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17900413982087127529)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17900414076523127529)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17900413896218127529)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15009933921079843279)
,p_branch_name=>'Go To CUSTOMERS after delete'
,p_branch_action=>'f?p=&APP_ID.:CUSTOMERS:&SESSION.::&DEBUG.:::'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(17900413896218127529)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15168091399478894150)
,p_branch_name=>'goto edit customer on create'
,p_branch_action=>'f?p=&APP_ID.:50:&SESSION.::&DEBUG.:RP,50:P50_ID:&P2_ID.'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(17900414076523127529)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17900414297187127545)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(162114299012310661)
,p_name=>'P2_REFERENCABLE'
,p_item_sequence=>470
,p_item_plug_id=>wwv_flow_api.id(17900413693548127528)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(162115145068314786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(162115932306316993)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(162116244798319163)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1085660200423532245)
...
,p_field_template=>wwv_flow_api.id(14959370620237679187)
,p_item_template_options=>'#DEFAULT#'
,p_required_patch=>wwv_flow_api.id(1263332554156881504)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1085660308358532246)
...
,p_required_patch=>wwv_flow_api.id(1263332270599875393)
,p_attribute_01=>'0'
,p_attribute_02=>'100'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1085660616652532249)
...
,p_field_template=>wwv_flow_api.id(14959370620237679187)
,p_item_template_options=>'#DEFAULT#'
,p_required_patch=>wwv_flow_api.id(1263333678179908262)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1085660772572532250)
,p_name=>'P2_CURRENCY'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(17900413693548127528)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14377966444717578814)
,p_name=>'P2_LOGO'
,p_item_sequence=>460
,p_item_plug_id=>wwv_flow_api.id(14377966315846578813)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Logo'
,p_source=>'LOGO_BLOB'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14566539564134999083)
,p_name=>'P2_LOGO_NAME'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_api.id(14377966315846578813)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14566544633205002840)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14566586876120025167)
,p_name=>'P2_LOGO_BLOB'
,p_item_sequence=>450
,p_item_plug_id=>wwv_flow_api.id(14377966315846578813)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964728674144805678)
,p_name=>'P2_SUMMARY'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(17813728278233726439)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15132138231852435213)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15168517294755929479)
...
,p_field_template=>wwv_flow_api.id(14959370620237679187)
,p_item_template_options=>'#DEFAULT#'
,p_required_patch=>wwv_flow_api.id(14975584692285760063)
,p_help_text=>'Enter the number of users / employees.'
,p_attribute_03=>'right'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15944610753957393482)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16712470018411594131)
,p_name=>'P2_LINKEDIN'
,p_item_sequence=>220
,p_item_plug_id=>wwv_flow_api.id(17893933129358456296)
,p_use_cache_before_default=>'NO'
,p_prompt=>'LinkedIn'
,p_source=>'LINKEDIN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16712470194300596691)
,p_name=>'P2_FACEBOOK'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_api.id(17893933129358456296)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16712474411811790923)
,p_name=>'P2_TWITTER'
,p_item_sequence=>240
,p_item_plug_id=>wwv_flow_api.id(17893933129358456296)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16750658207028884060)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16988982908280331116)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17102156005507231772)
,p_name=>'P2_TYPE_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(17813728278233726439)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17102157418742231786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17821164833452639507)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17894619217113619287)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17894619427156622265)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17894947513275808098)
,p_name=>'P2_ROW_KEY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17900413693548127528)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17896141634478412898)
,p_name=>'P2_TAGS'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(17813728278233726439)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900414395353127545)
,p_name=>'P2_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17900413693548127528)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900414482672127545)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900414683381127559)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900414978546127567)
,p_name=>'P2_STATUS_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(17900413693548127528)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900415673604127568)
,p_name=>'P2_WEB_SITE'
,p_item_sequence=>210
,p_item_plug_id=>wwv_flow_api.id(17893933129358456296)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900415893895127570)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900416083318127570)
,p_name=>'P2_SIC'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(17893933129358456296)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900416301044127570)
,p_name=>'P2_DUNS'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(17893933129358456296)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17900459478270598943)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17928633167450741042)
,p_name=>'P2_REQUEST'
,p_item_sequence=>420
,p_item_plug_id=>wwv_flow_api.id(17900418872159127603)
,p_use_cache_before_default=>'NO'
,p_source=>'P2_REQUEST'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18560515915689188908)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18560516084200188909)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(17900414899734127562)
...
,p_when_button_pressed=>wwv_flow_api.id(17900413982087127529)
,p_associated_item=>wwv_flow_api.id(17900414683381127559)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(17900415179785127567)
...
,p_when_button_pressed=>wwv_flow_api.id(17900413982087127529)
,p_associated_item=>wwv_flow_api.id(17900414978546127567)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(18560516110168188910)
...
,p_associated_item=>wwv_flow_api.id(18560516084200188909)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(18560516189165188911)
...
,p_associated_item=>wwv_flow_api.id(18560515915689188908)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(375439718659839396)
...
,p_associated_item=>wwv_flow_api.id(17896141634478412898)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566680048450541492)
...
,p_associated_item=>wwv_flow_api.id(17900415673604127568)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566680208370541493)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_api.id(16712470194300596691)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566680257422541494)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_api.id(16712470018411594131)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566680333386541495)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_api.id(16712474411811790923)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17900418488649127596)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17900418589168127596)
