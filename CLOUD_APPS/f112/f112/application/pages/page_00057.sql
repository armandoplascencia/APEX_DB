...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15790448394409350517)
,p_plug_name=>'Users'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(15790448505536350517)
,p_name=>'Manage Users'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15790448698593350530)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15790448809368350532)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15790448897640350532)
...
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_rpt_named_lov=>wwv_flow_api.id(15790759109926429854)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15790449015348350533)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15790449099415350533)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(16104479304427169922)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(15790453099527351229)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14845399513231728215)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(15790448394409350517)
,p_button_name=>'RESET'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14915491123258725352)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15928664208304824712)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(15015801610632255238)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1760121878184982090)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1760122261878982098)
,p_event_id=>wwv_flow_api.id(1760121878184982090)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(15790448394409350517)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1760122727364982099)
,p_event_id=>wwv_flow_api.id(1760121878184982090)
,p_event_result=>'TRUE'
