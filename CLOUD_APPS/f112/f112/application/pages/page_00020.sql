...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17905922968153275852)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14949730122106576921)
,p_plug_name=>'Social'
,p_parent_plug_id=>wwv_flow_api.id(17905922968153275852)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14949733308431610812)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17905923567563275855)
,p_plug_name=>'Contact Details'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17905924269039275856)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(17905923567563275855)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17905924658551275857)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17905924857694275857)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17905924460276275857)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(17905937079554275874)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14949729304451570538)
,p_name=>'P20_FACEBOOK'
,p_item_sequence=>310
,p_item_plug_id=>wwv_flow_api.id(14949730122106576921)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14949731108104583969)
,p_name=>'P20_LINKEDIN'
,p_item_sequence=>320
,p_item_plug_id=>wwv_flow_api.id(14949730122106576921)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14949731601635587018)
,p_name=>'P20_TWITTER'
,p_item_sequence=>330
,p_item_plug_id=>wwv_flow_api.id(14949730122106576921)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905141630267853905)
,p_name=>'P20_CUSTOMER_ID'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Customer'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905925064393275857)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905927271444275860)
,p_name=>'P20_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905927476194275860)
,p_name=>'P20_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905927976201275861)
,p_name=>'P20_TITLE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905928477232275861)
,p_name=>'P20_COMPANY'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905928977059275862)
,p_name=>'P20_ADDRESS_LINE1'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(14949733308431610812)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Address '
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905929456219275862)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905929978228275863)
,p_name=>'P20_CITY'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(14949733308431610812)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905930474865275863)
,p_name=>'P20_STATE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(14949733308431610812)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905930963225275864)
,p_name=>'P20_COUNTRY'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(14949733308431610812)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905931483400275864)
,p_name=>'P20_ZIP'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(14949733308431610812)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905931960909275865)
,p_name=>'P20_EMAIL'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905932459443275865)
,p_name=>'P20_PHONE'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905932967294275866)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905933464773275866)
,p_name=>'P20_FAX'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905933967025275867)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17905934479689275867)
,p_name=>'P20_NOTES'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17909047831195400469)
,p_name=>'P20_TAGS'
,p_item_sequence=>192
,p_item_plug_id=>wwv_flow_api.id(17905922968153275852)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17928590581360499110)
,p_name=>'P20_REQUEST'
,p_item_sequence=>300
,p_item_plug_id=>wwv_flow_api.id(17905923567563275855)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(15025354001448966558)
...
,p_associated_item=>wwv_flow_api.id(17905927476194275860)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(375464255483427498)
...
,p_validation_condition=>'CREATE,SAVE'
,p_validation_condition_type=>'REQUEST_IN_CONDITION'
,p_associated_item=>wwv_flow_api.id(17909047831195400469)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566682676289541518)
...
,p_associated_item=>wwv_flow_api.id(14949729304451570538)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566682778791541519)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_api.id(14949731108104583969)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(566682873525541520)
...
,p_validation_condition_type=>'ITEM_IS_NOT_NULL'
,p_associated_item=>wwv_flow_api.id(14949731601635587018)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17905936158783275870)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17905936372622275870)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17905936571809275870)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_api.id(17905924460276275857)
,p_security_scheme=>wwv_flow_api.id(16066770301217181173)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17927530372618888013)
