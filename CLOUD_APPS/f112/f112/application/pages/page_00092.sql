...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1206077410877222558)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1206077501133222559)
,p_region_id=>wwv_flow_api.id(1206077410877222558)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1206077596994222560)
,p_chart_id=>wwv_flow_api.id(1206077501133222559)
,p_seq=>10
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1206077767830222561)
,p_chart_id=>wwv_flow_api.id(1206077501133222559)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1206077836896222562)
,p_chart_id=>wwv_flow_api.id(1206077501133222559)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15970196467213692418)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15970197434521696814)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15974081773623634733)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15970196467213692418)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15970197744950696820)
,p_name=>'P92_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15970197434521696814)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15974072321807508863)
,p_name=>'P92_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15970197434521696814)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15970366745956017609)
,p_name=>'prod counts'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1206078082773222564)
,p_event_id=>wwv_flow_api.id(15970366745956017609)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(1206077410877222558)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15974072890568527787)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1206077977109222563)
,p_event_id=>wwv_flow_api.id(15974072890568527787)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
