...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15988883103436098178)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15486028279593205632)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15988883103436098178)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15486027466847205631)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15486027137324205631)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15486027920664205631)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15486030970287205641)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(434366146255178369)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(15486028279593205632)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(434366240608178370)
,p_event_id=>wwv_flow_api.id(434366146255178369)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15486029726933205639)
...
,p_process_when_button_id=>wwv_flow_api.id(15486027920664205631)
,p_process_success_message=>'Sample data reset.'
,p_security_scheme=>wwv_flow_api.id(15775842108167638827)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15486030091330205641)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(15486027466847205631)
,p_process_success_message=>'Sample Data Removed'
,p_security_scheme=>wwv_flow_api.id(15775842108167638827)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15486030505199205641)
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(15486027137324205631)
