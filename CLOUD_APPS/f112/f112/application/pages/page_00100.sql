...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(585544560710983350)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(585544646571983351)
,p_region_id=>wwv_flow_api.id(585544560710983350)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(585544778533983352)
,p_chart_id=>wwv_flow_api.id(585544646571983351)
,p_seq=>10
,p_name=>'Geography'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(585544950604983354)
,p_chart_id=>wwv_flow_api.id(585544646571983351)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(585544842155983353)
,p_chart_id=>wwv_flow_api.id(585544646571983351)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(585545007874983355)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(585545094833983356)
,p_region_id=>wwv_flow_api.id(585545007874983355)
,p_chart_type=>'bar'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
,p_orientation=>'vertical'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(585545233350983357)
,p_chart_id=>wwv_flow_api.id(585545094833983356)
,p_seq=>10
,p_name=>'Geography'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(585545330380983358)
,p_chart_id=>wwv_flow_api.id(585545094833983356)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(585545424455983359)
,p_chart_id=>wwv_flow_api.id(585545094833983356)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20347054197579667828)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20347054515846667837)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20347055774491667840)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20347056898508667843)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20347057333455667844)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20347057712945667844)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_api.id(20347057333455667844)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20347054914338667837)
,p_name=>'P100_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20347054515846667837)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20347055330303667840)
,p_name=>'P100_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(20347054515846667837)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(20347060788375667855)
,p_name=>'cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20347062352685667856)
,p_event_id=>wwv_flow_api.id(20347060788375667855)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(20347056898508667843)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20347062826685667856)
,p_event_id=>wwv_flow_api.id(20347060788375667855)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(20347054197579667828)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(20347058450085667850)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20347059937662667854)
,p_event_id=>wwv_flow_api.id(20347058450085667850)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20347060425516667855)
,p_event_id=>wwv_flow_api.id(20347058450085667850)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
