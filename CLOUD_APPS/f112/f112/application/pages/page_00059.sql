...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(14377966939187578819)
...
,p_query_row_template=>wwv_flow_api.id(15121362028325015965)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15100473804934547278)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15100473913675547279)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15100474008634547280)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15100474163352547281)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15100474217864547282)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15096818108876351871)
,p_query_column_id=>6
,p_column_alias=>'ID'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14964673910663772732)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(14964858472985877160)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(16988980555638331092)
,p_query_column_id=>1
,p_column_alias=>'CARD_LINK'
,p_column_display_sequence=>1
,p_column_heading=>'Card link'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(16988980601314331093)
,p_query_column_id=>2
,p_column_alias=>'CARD_TITLE'
,p_column_display_sequence=>2
,p_column_heading=>'Card title'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(16988980778340331094)
,p_query_column_id=>3
,p_column_alias=>'CARD_TEXT'
,p_column_display_sequence=>3
,p_column_heading=>'Card text'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(16988980801224331095)
,p_query_column_id=>4
,p_column_alias=>'CARD_SUBTEXT'
,p_column_display_sequence=>4
,p_column_heading=>'Card subtext'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(16988980895979331096)
,p_query_column_id=>5
,p_column_alias=>'CARD_INITIALS'
,p_column_display_sequence=>5
,p_column_heading=>'Card initials'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14964873984520947150)
,p_plug_name=>'Filters'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15853994430340866997)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(15853994669458867002)
,p_name=>'Customers'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15853994793677867007)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854002042824867019)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854003177741867023)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854003561085867023)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854004049811867024)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854004445678867026)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854004793726867026)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854005151580867026)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854002796876867021)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854002362615867019)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854005620515867027)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854005959704867029)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854006437459867032)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854006803554867033)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854007189722867033)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854007585487867035)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854007966255867036)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854008358498867038)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15854008780145867038)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15944312147633151729)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15944642259606450888)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15944643869562452412)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(15222939113502577687)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17031760248266621075)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17102156909438231781)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17102157242902231784)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(17241813273871235874)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(18560516446680188913)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(18560516549737188914)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1207483758897757244)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1207483871043757245)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1207483907952757246)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(2146552715165370776)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(15854009215056867039)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15854009963014906544)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18035691297377272786)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20326236312663461284)
,p_plug_name=>'&APPLICATION_TITLE.'
,p_icon_css_classes=>'app-customer-tracker'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(14959350066146679138)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20326236676899461287)
,p_plug_name=>'Search'
,p_parent_plug_id=>wwv_flow_api.id(20326236312663461284)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(20326961071192604987)
...
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_api.id(14975110784222090223)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(20326961365348604992)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(20326961709216604994)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(20326962129884604995)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(20326962493331604996)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(20326962952175604996)
,p_query_column_id=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20326964773846606460)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20326998211396821566)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20326999786734822814)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(18079608714310970053)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14974451199134993233)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(14964873984520947150)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15872092396631517664)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(20326236312663461284)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20326965045450606463)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(20326964773846606460)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17241813285757235875)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15853994430340866997)
,p_button_name=>'RESET'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(1259650423340461236)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1197775211659139151)
,p_name=>'P59_DISPLAY_AS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20326236676899461287)
,p_item_default=>'CARDS'
,p_prompt=>'Display as'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'HOMEPAGE_DISPLAY_AS'
,p_lov=>'.'||wwv_flow_api.id(1250301436662674421)||'.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12099724313694829419)
,p_name=>'P59_REFERENCE_TYPES'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(14964873984520947150)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964875350306958674)
,p_name=>'P59_GEO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(14964873984520947150)
,p_item_default=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964876567788964214)
,p_name=>'P59_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(14964873984520947150)
,p_prompt=>'Search'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964877250236968815)
,p_name=>'P59_INDUSTRY'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
,p_item_default=>'0'
,p_prompt=>'Industry'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964877802937979000)
,p_name=>'P59_CATEGORY'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
,p_item_default=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964905518363036693)
,p_name=>'P59_MAX_ROWS'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
,p_item_default=>'20'
...
,p_lov=>'.'||wwv_flow_api.id(14964917898750120661)||'.'
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14964922149425220896)
,p_name=>'P59_STATUS'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(14964873984520947150)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15132136154970435192)
...
,p_lov=>'.'||wwv_flow_api.id(15144238896538155541)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(15121363926353015980)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15132138463646435215)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15132138523031435216)
,p_name=>'P59_SCP_CUST'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16988983120136331118)
,p_name=>'P59_PRODUCT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(14964873984520947150)
,p_item_default=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17102156252480231774)
,p_name=>'P59_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
,p_prompt=>'Type'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17102157176749231783)
,p_name=>'P59_USE_CASE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
,p_prompt=>'Use Case'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17102158062194231792)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17241815846066235900)
,p_name=>'P59_COUNTRY'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(18035691297377272786)
,p_prompt=>'Country'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17848827197296609493)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17848827871659609499)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17848828813052609509)
,p_name=>'P59_SORT'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(14964873984520947150)
,p_prompt=>'Sort By'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(14964916372615114180)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15777538641884642242)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15777538749244642243)
,p_event_id=>wwv_flow_api.id(15777538641884642242)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(14964858472985877160)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15096818928781351879)
,p_event_id=>wwv_flow_api.id(15777538641884642242)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(14377966939187578819)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15777538770019642244)
,p_event_id=>wwv_flow_api.id(15777538641884642242)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15132134806015435179)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15132134921428435180)
,p_event_id=>wwv_flow_api.id(15132134806015435179)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15132135152635435182)
,p_event_id=>wwv_flow_api.id(15132134806015435179)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15132135544422435186)
,p_event_id=>wwv_flow_api.id(15132134806015435179)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15132135814126435189)
,p_event_id=>wwv_flow_api.id(15132134806015435179)
,p_event_result=>'FALSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15100474430176547284)
,p_name=>'Reset Search Filters'
,p_event_sequence=>234
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(14974451199134993233)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15100474563517547285)
,p_event_id=>wwv_flow_api.id(15100474430176547284)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15100475324749547293)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15100475395388547294)
,p_event_id=>wwv_flow_api.id(15100475324749547293)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1197775384717139152)
,p_name=>'Set Logo Sizes on Region Refresh'
,p_event_sequence=>264
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(14377966939187578819)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1197775394368139153)
,p_event_id=>wwv_flow_api.id(1197775384717139152)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
