...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1084206062851473850)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2968910501585385142)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(439009468273656951)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1084206062851473850)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(439009016298656950)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(439019214343656974)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(439010184510656951)
,p_name=>'P130_AC_ENABLED'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2968910501585385142)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(439010535297656953)
...
,p_lov=>'.'||wwv_flow_api.id(439019583185656977)||'.'
,p_field_template=>wwv_flow_api.id(366876077082757148)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(439010933096656953)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(439011295547656957)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(439013647283656970)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439014093903656971)
,p_event_id=>wwv_flow_api.id(439013647283656970)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439014597655656971)
,p_event_id=>wwv_flow_api.id(439013647283656970)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(439015910585656972)
,p_name=>'APPLY CHANGES WHEN AC ENABLED'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(439009468273656951)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439016395312656972)
,p_event_id=>wwv_flow_api.id(439015910585656972)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(439016821725656972)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439017327268656972)
,p_event_id=>wwv_flow_api.id(439016821725656972)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439017812426656973)
,p_event_id=>wwv_flow_api.id(439016821725656972)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(439018189689656973)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439018702030656973)
,p_event_id=>wwv_flow_api.id(439018189689656973)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(439015072952656971)
,p_name=>'Cancel Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(439009016298656950)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(439015519633656971)
,p_event_id=>wwv_flow_api.id(439015072952656971)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(439012463731656969)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(439012880998656969)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(439013247582656970)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(439012073370656969)
