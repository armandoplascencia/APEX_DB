...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1206076814471222552)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1206076968689222553)
,p_region_id=>wwv_flow_api.id(1206076814471222552)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1206077008551222554)
,p_chart_id=>wwv_flow_api.id(1206076968689222553)
,p_seq=>10
,p_name=>'Geography'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1206077114363222555)
,p_chart_id=>wwv_flow_api.id(1206076968689222553)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1206077258784222556)
,p_chart_id=>wwv_flow_api.id(1206076968689222553)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15871106834925222831)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15970202044980712245)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15974082282743639279)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15871106834925222831)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15970202311776712246)
,p_name=>'P85_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15970202044980712245)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15970347212618833480)
,p_name=>'set cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1206077375397222557)
,p_event_id=>wwv_flow_api.id(15970347212618833480)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(1206076814471222552)
);
