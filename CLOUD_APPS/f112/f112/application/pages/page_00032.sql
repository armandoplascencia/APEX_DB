...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1206076095197222545)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1206076279225222546)
,p_region_id=>wwv_flow_api.id(1206076095197222545)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1206076297243222547)
,p_chart_id=>wwv_flow_api.id(1206076279225222546)
,p_seq=>10
,p_name=>'Category'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1206076497326222549)
,p_chart_id=>wwv_flow_api.id(1206076279225222546)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1206076474073222548)
,p_chart_id=>wwv_flow_api.id(1206076279225222546)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15871101415361173107)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15970198234594699340)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15974082643034641827)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15871101415361173107)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15970198510537699341)
,p_name=>'P32_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15970198234594699340)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15974083353688647990)
,p_name=>'P32_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15970198234594699340)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15970203521042720401)
,p_name=>'set cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1206076641345222550)
,p_event_id=>wwv_flow_api.id(15970203521042720401)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(1206076095197222545)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15974083830826654564)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1206076756062222551)
,p_event_id=>wwv_flow_api.id(15974083830826654564)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
