prompt --application/shared_components/user_interface/templates/report/standard_logs_borderless
begin
--   Manifest
--     ROW TEMPLATE: STANDARD_LOGS_BORDERLESS_
--   Manifest End
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(66994129745092672979)
,p_row_template_name=>'Standard - Logs borderless '
,p_internal_name=>'STANDARD_LOGS_BORDERLESS_'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" style="background-color: #FCD9D9;">#COLUMN_VALUE#</td>'
,p_row_template_condition1=>'UPPER(:STATUS) = UPPER(''FAILED'')'
,p_row_template2=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" style="background-color: #d9fcd9;">#COLUMN_VALUE#</td>'
,p_row_template_condition2=>'UPPER(:STATUS) = UPPER(''SUCCEEDED'')'
,p_row_template3=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
