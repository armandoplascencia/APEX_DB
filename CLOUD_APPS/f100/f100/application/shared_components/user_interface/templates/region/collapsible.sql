...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(46076725607878702)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(46077076871878702)
,p_plug_template_id=>wwv_flow_api.id(46076725607878702)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(46077349729878702)
,p_plug_template_id=>wwv_flow_api.id(46076725607878702)
,p_name=>'Sub Regions'
