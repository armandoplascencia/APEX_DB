...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57455886846067150)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57456153341067150)
,p_plug_template_id=>wwv_flow_api.id(57455886846067150)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57456455775067151)
,p_plug_template_id=>wwv_flow_api.id(57455886846067150)
,p_name=>'Sub Regions'
