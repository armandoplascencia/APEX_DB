...
@@application/shared_components/files/sam_dw_qliq_png.sql
@@application/shared_components/files/quicksql_script_1_sql.sql
@@application/shared_components/files/070830_drm_abstract_model_jpg.sql
@@application/shared_components/files/cookright_png_1_png.sql
...
@@application/shared_components/user_interface/lovs/dw_brand_brand_name.sql
@@application/shared_components/user_interface/lovs/dw_customer_cust_rpt_l0_exec.sql
@@application/shared_components/user_interface/lovs/dw_internal_miso_rpt_l0_exec.sql
@@application/shared_components/user_interface/lovs/dw_location_country.sql
@@application/shared_components/user_interface/lovs/dw_miso_date_dim_day_name.sql
@@application/shared_components/user_interface/lovs/dw_miso_periods_level_0_all.sql
@@application/shared_components/user_interface/lovs/dw_miso_time_hhmmss_dim_time.sql
@@application/shared_components/user_interface/lovs/dw_product_product_name.sql
