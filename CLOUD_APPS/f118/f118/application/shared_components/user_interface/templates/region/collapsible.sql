...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(71852444400536835)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(71852790319536835)
,p_plug_template_id=>wwv_flow_api.id(71852444400536835)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(71853037499536835)
,p_plug_template_id=>wwv_flow_api.id(71852444400536835)
,p_name=>'Sub Regions'
