...
@@application/shared_components/navigation/lists/dts_pos_mgr_1.sql
@@application/shared_components/navigation/lists/dts_pos_mgr_2.sql
@@application/shared_components/navigation/lists/dts_pos_mgr_3.sql
@@application/shared_components/navigation/lists/dts_pos_mgr_4.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/model_3_ws_png.sql
@@application/shared_components/files/ws_entity_model_1_png.sql
@@application/shared_components/files/model_2_ws_png.sql
@@application/shared_components/files/model_4_ws_png.sql
...
@@application/shared_components/user_interface/lovs/wb_author_author_name.sql
@@application/shared_components/user_interface/lovs/wb_business_process_process_name.sql
@@application/shared_components/user_interface/lovs/wb_bus_process_event_possible_retired_state.sql
@@application/shared_components/user_interface/lovs/wb_document_document_name.sql
@@application/shared_components/user_interface/lovs/wb_document_key_words_key_words.sql
@@application/shared_components/user_interface/lovs/wb_document_status_document_status_name.sql
@@application/shared_components/user_interface/lovs/wb_document_type_document_type_name.sql
@@application/shared_components/user_interface/lovs/wb_event_event_name.sql
@@application/shared_components/user_interface/lovs/wb_event_type_event_type_code.sql
@@application/shared_components/user_interface/lovs/wb_interface_actions_url_full_spec.sql
@@application/shared_components/user_interface/lovs/wb_interface_auth_access_token.sql
@@application/shared_components/user_interface/lovs/wb_interface_contrib_the_in.sql
@@application/shared_components/user_interface/lovs/wb_interface_file_name.sql
@@application/shared_components/user_interface/lovs/wb_resources_name.sql
@@application/shared_components/user_interface/lovs/wb_system_name_system_name.sql
@@application/shared_components/user_interface/lovs/wb_transaction_tranaction_type_desc.sql
@@application/shared_components/user_interface/lovs/wb_transaction_type_tranaction_type_code.sql
@@application/shared_components/user_interface/lovs/wb_web_service_catalog_url_endpoint.sql
...
@@application/shared_components/logic/webservices/brinks_budgets_svc.sql
@@application/shared_components/logic/webservices/getorders_sales2.sql
