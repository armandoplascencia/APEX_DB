...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(41711109135533105)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41711490655533105)
,p_plug_template_id=>wwv_flow_api.id(41711109135533105)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41711700292533105)
,p_plug_template_id=>wwv_flow_api.id(41711109135533105)
,p_name=>'Sub Regions'
